          ...
          <div className="flex flex-wrap gap-4">
            {currentCategory.types.map((type, idx) => (
              <button
                ...
                className="px-5 py-2 capitalize border border-blue-500 rounded-md text-blue-600 hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
                type="button"
              >
                {type}
              </button>
