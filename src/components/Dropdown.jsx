  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute left-0 top-full flex flex-wrap mt-1 w-full bg-white border border-blue-300 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-20"
      >
        {lists.types.map((type, i) => (
          <div
            ...
            tabIndex={-1}
            key={i}
            className="px-4 py-2 text-left w-xs text-gray-900 hover:bg-blue-600 capitalize hover:text-white transition cursor-pointer rounded-md"
