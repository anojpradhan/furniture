...
const Dropdown = ({ lists }) => {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="w-full px-4 py-3 text-centre font-medium hover:bg-blue-600 capitalize  hover:text-white transition focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-md"
      >
        {lists.title}
      </button>
      ...
      >
        {lists.types.map((type, i) => (
          <div
            ...
            tabIndex={-1}
            key={i}
            className="px-4 py-2 text-left text-gray-900 hover:bg-blue-600 capitalize hover:text-white transition cursor-pointer rounded-md"
