...
const Dropdown = ({ lists }) => {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="w-full px-4 py-3 text-left font-medium hover:bg-blue-600 capitalize  hover:text-white transition focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-md"
      >
        {lists.title}
      </button>
